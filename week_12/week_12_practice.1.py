...
ps = PlanetarySystem("slanetarysystem1", Star("star1"))
ps.add_planet(Planet("planet1",1,2,3))
ps.add_planet(Planet("planet2",1,2,3))

ps.show_planets

new_system = solar_system + ps
# want a new system that has all the planets from each